     ...
     <div class="data-input">
        <table>
         <form action="/" method="POST">
            ...
            <td style="width:22">
                <input type="number" name="Pattern" min="1" max="75" value="37" class="button-blue" style="width:30%" id="Modepat">
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed1" min="50" max="350" value="250" class="slider" id="mySpeed1">
